...
See [wording review](empathy-relevance-review.md) for the addressed opposite-pole/cross-loading concerns and remaining author-review gates, including a Chapter 3/4 source discrepancy. The full manuscript was available privately for this pass. Bank-size decisions and instrument validation remain separate work under issue #24; PR #50 remains a draft.
