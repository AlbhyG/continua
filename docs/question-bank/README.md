...
The current manuscript is available through the [private manuscript retrieval instructions](../manuscript/README.md). Retrieve and read it before manuscript-grounded edits. The external review is not bundled here. The export is ready for the handoff; no external review is claimed. Review any resulting changes before regenerating/versioning live questionnaires.
