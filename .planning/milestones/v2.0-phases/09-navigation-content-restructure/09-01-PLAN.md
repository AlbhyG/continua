...
NOTE: Do NOT delete the old /who and /what page files in this plan. Plan 02 handles deletion after it has copied the content from those pages into the new pages.
  </action>
  <verify>
Run `npm run build` -- should complete without errors. Verify `next.config.ts` contains redirects function with /who and /what entries. Verify home page h1 contains "The Personality Continua".
  </verify>
  <done>Visiting /who redirects to /my-relationships with 308 status. Visiting /what redirects to /my-info with 308 status. Home page heading reads "The Personality Continua".</done>
</task>
...
6. No internal links in Header.tsx pointing to /who or /what
</verification>
