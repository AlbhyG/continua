      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
        <DialogPanel className="max-w-md w-full rounded-xl bg-white/95 backdrop-blur shadow-lg p-6">
          ...
          <Description className="text-sm text-gray-600 mt-2">
            Enter your information to receive the Publishers Book. We'll send you a verification email to confirm your email address.
          </Description>

          <form action={formAction} className="mt-4 space-y-4">
            <input type="hidden" name="book_type" value="publishers" />
