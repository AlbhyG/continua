  ...
  return (
    <main className="max-w-[720px] lg:max-w-[960px] mx-auto px-6 pt-20 pb-12">
      ...
      <section className="space-y-8">
        ...
        <div>
          <h2 className="text-[24px] md:text-[28px] font-bold mb-3">For Couples</h2>
          <p className="text-[18px] md:text-[20px] leading-[1.6]">
        ...
        <div>
          <h2 className="text-[24px] md:text-[28px] font-bold mb-3">For Families</h2>
          <p className="text-[18px] md:text-[20px] leading-[1.6]">
        ...
        <div>
          <h2 className="text-[24px] md:text-[28px] font-bold mb-3">For Teams</h2>
          <p className="text-[18px] md:text-[20px] leading-[1.6]">
