...
export const metadata: Metadata = {
  title: 'My Relationships (v2) | Continua',
...
export default function V2MyRelationshipsPage() {
  return (
    <div>
      {/* Page header */}
        ...
        <FadeIn delay={400}>
          <div className="glass-card p-6">
            <p className="text-[17px] md:text-[19px] leading-[1.7] text-foreground/75 italic">
              ...
              <Link href="/v2/my-info" className="text-accent underline underline-offset-2 hover:text-accent/80 transition-colors">
                My Info
              </Link>{' '}
