...
const sections = [
  ...
  },
  {
    ...
    names:
      'Caligula, Nero, Alexander The Great, Genghis Khan, Vincent van Gogh, Ernest Hemingway, Jim Morrison, Kurt Cobain, Amy Winehouse, Mike Tyson, Diego Maradona, John McEnroe, Dennis Rodman, Kanye West (Ye), Charlie Sheen, Lindsay Lohan, Britney Spears, Oscar Wilde',
  },
  {
    title: 'Very Assertive',
    names:
      'Napoleon Bonaparte, Winston Churchill, Margaret Thatcher, Genghis Khan, Julius Caesar, Catherine the Great, Queen Elizabeth I, Joan of Arc, Theodore Roosevelt, George Patton, Indira Gandhi, Golda Meir, Cleopatra, Alexander The Great, Angela Merkel',
  },
  {
    title: 'Yielding',
    names:
      'Mahatma Gandhi, Nelson Mandela, Dalai Lama, Mother Teresa, Rosa Parks, Martin Luther King Jr., Princess Diana, Fred Rogers, Jimmy Carter, Desmond Tutu, Jane Goodall, Albert Schweitzer, Thich Nhat Hanh',
  },
  {
    title: 'Highly Reactive',
    names:
      'Kanye West (Ye), Mel Gibson, Vincent van Gogh, Naomi Campbell, Alec Baldwin, Christian Bale, Sean Penn, Russell Crowe, Bobby Knight, John McEnroe, Sinead O\u2019Connor, Courtney Love, Amy Winehouse',
  },
  {
    title: 'Low Reactivity',
    names:
      'Dalai Lama, Barack Obama, Tom Hanks, Denzel Washington, Marcus Aurelius, Queen Elizabeth II, Angela Merkel, Keanu Reeves, Morgan Freeman, Fred Rogers, Bob Ross, Nelson Mandela, Abraham Lincoln',
  },
]
